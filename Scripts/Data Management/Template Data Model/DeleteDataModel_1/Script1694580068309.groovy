...
WebUI.setText(findTestObject('Page_Qun l biu mu/input_Ten_Filter'), TemplateNameEdit)

WebUI.sendKeys(findTestObject('Page_Qun l biu mu/input_Ten_Filter'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Page_Qun l biu mu/a_iconXoa'))
...
WebUI.getText(findTestObject('Page_Qun l biu mu/div_Ban co chac chan muon xoa khong'), FailureHandling.STOP_ON_FAILURE)
